...
<head>
    ...
    <meta content="Sistema de Gestion Administrativa" name="description"/>
    <meta content="Henrry Surco Alvan" name="author"/>
    <?= Html::csrfMetaTags() ?>
    <?php $this->head() ?>
...
<div class="page-wrapper">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile"> <?= $user->identity->username; ?> </span>
    ...
    <div class="page-container">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item start active">
                            <a href="<?= $baseUrl ?>" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="<?= Url::to(['person/index']) ?>" class="nav-link">
                                        <i class="icon-users"></i>
                                        <span class="title">Personas</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= Url::to(['person/create']) ?>" class="nav-link">
                                        <i class="icon-user"></i>
                                        <span class="title">Nueva Persona</span>
                                    </a>
                                </li>

                            </ul>
                        </li>
                        <!-- Eso es parte del menu del dashboard -->
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-doc"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="<?= Url::to(['teaching/index']) ?>" class="nav-link">
                                        <i class="icon-briefcase"></i>
                                        <span class="title">Lista de Asignación</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item  ">
                            <a href="<?= Url::to(['income/index']) ?>" class="nav-link nav-toggle">
                                <i class="icon-map"></i>
                                <span class="title">Ubicación Geografica</span>
                            </a>
                        </li>
                        <li class="heading">
                        ...
                        <li class="nav-item  ">
                            <a href="<?= Url::to(['school/index']) ?>" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                                <span class="title">Colegios</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="<?= Url::to(['course/index']) ?>" class="nav-link nav-toggle">
                                <i class="icon-bulb"></i>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content"
                <?= ($user->isGuest)? 'style="margin-left: 0;"':'' ?>><?= $content ?></div>
            <!-- END CONTENT BODY -->
        </div>
        <!-- END CONTENT -->
        <?php if (!$user->isGuest) : ?>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar10.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar11.jpg" alt="...">
                                        <div class="media-body">
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar3.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="<?= $baseUrl ?>/assets/layouts/layout/img/avatar2.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> <?= date('Y') ?> &copy; S.G.A.U.D. </div>
